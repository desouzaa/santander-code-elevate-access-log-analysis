...
# MAGIC %md
# MAGIC ####Execute a célula abaixo para importar as funções da classe ETLPipeline
...
# MAGIC %md
# MAGIC ####Execute a célula abaixo para criar os parâmetros a serem usados no ETLPipeline

# COMMAND ----------

#Essa variável contém a regra sql para gerar a tabela gold que irá armazenar as metricas e insights necessários para o desafio, mas para outras execuções, poderia ser alterada de acordo com a demanda
sql_regra_gold = """
...
#Definir parâmetros para rodar o ETL
params = {
...
# MAGIC %md
# MAGIC #### Execute a célula abaixo para instanciar a classe ETLPipeline com os parâmetros criados acima
...
# MAGIC %md
# MAGIC #### Execute a célula abaixo para rodar o pipeline completo desde a extração até a criação da tabela Gold
